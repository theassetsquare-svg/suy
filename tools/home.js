...
const HOME = {
  title: '새벽 4시, 무너진 뒤 다시 일어선 여덟 달의 기록',
  desc: '모든 걸 잃고 강북 큰길을 걷던 사람이 여덟 달 만에 다시 일어서기까지의 기록입니다. 오늘 하루가 유난히 무거운 분께 권합니다.',
  h1: '새벽 4시, 다시 일어선 사람의 이야기',
  imgAlt: '새벽 4시, 다시 일어선 사람의 이야기',
  siteName: '새벽 4시의 기록',
